...
$("#ingest-button").addEventListener("click", () => { elements.ingestReport.value = JSON.stringify({ results: [{ check_id: "csharp.security.demo-rule", path: "src/Payments/PaymentController.cs", start: { line: 24 }, extra: { severity: "WARNING", message: "Untrusted input reaches a sensitive operation." } }] }, null, 2); elements.ingestMessage.textContent = ""; elements.ingestDialog.showModal(); });
